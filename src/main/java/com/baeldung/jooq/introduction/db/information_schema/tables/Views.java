...
import com.baeldung.jooq.introduction.db.information_schema.enums.ViewsCheckOption;
import com.baeldung.jooq.introduction.db.information_schema.enums.ViewsIsUpdatable;
...
public class Views extends TableImpl<ViewsRecord> {
     ...
     */
    public final TableField<ViewsRecord, String> TABLE_CATALOG = createField(DSL.name("TABLE_CATALOG"), SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>information_schema.VIEWS.TABLE_SCHEMA</code>.
     */
    public final TableField<ViewsRecord, String> TABLE_SCHEMA = createField(DSL.name("TABLE_SCHEMA"), SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>information_schema.VIEWS.TABLE_NAME</code>.
     */
    public final TableField<ViewsRecord, String> TABLE_NAME = createField(DSL.name("TABLE_NAME"), SQLDataType.VARCHAR(64), this, "");
     ...
     */
    public final TableField<ViewsRecord, ViewsCheckOption> CHECK_OPTION = createField(DSL.name("CHECK_OPTION"), SQLDataType.VARCHAR(8).asEnumDataType(com.baeldung.jooq.introduction.db.information_schema.enums.ViewsCheckOption.class), this, "");

    /**
     * The column <code>information_schema.VIEWS.IS_UPDATABLE</code>.
     */
    public final TableField<ViewsRecord, ViewsIsUpdatable> IS_UPDATABLE = createField(DSL.name("IS_UPDATABLE"), SQLDataType.VARCHAR(3).asEnumDataType(com.baeldung.jooq.introduction.db.information_schema.enums.ViewsIsUpdatable.class), this, "");
