...
import com.baeldung.jooq.introduction.db.information_schema.tables.records.InnodbFtDeletedRecord;
...
public class InnodbFtDeleted extends TableImpl<InnodbFtDeletedRecord> {
     ...
     */
    public final TableField<InnodbFtDeletedRecord, ULong> DOC_ID = createField(DSL.name("DOC_ID"), SQLDataType.BIGINTUNSIGNED.nullable(false).defaultValue(DSL.inline("", SQLDataType.BIGINTUNSIGNED)), this, "");
