...
import com.baeldung.jooq.introduction.db.information_schema.tables.records.SchemataExtensionsRecord;
...
public class SchemataExtensions extends TableImpl<SchemataExtensionsRecord> {
     ...
     */
    public final TableField<SchemataExtensionsRecord, String> CATALOG_NAME = createField(DSL.name("CATALOG_NAME"), SQLDataType.VARCHAR(64), this, "");

    /**
     * The column
     * <code>information_schema.SCHEMATA_EXTENSIONS.SCHEMA_NAME</code>.
     */
    public final TableField<SchemataExtensionsRecord, String> SCHEMA_NAME = createField(DSL.name("SCHEMA_NAME"), SQLDataType.VARCHAR(64), this, "");
