...
import com.baeldung.jooq.introduction.db.information_schema.enums.EventsIntervalField;
import com.baeldung.jooq.introduction.db.information_schema.enums.EventsStatus;
import com.baeldung.jooq.introduction.db.information_schema.tables.records.EventsRecord;
...
public class Events extends TableImpl<EventsRecord> {
     ...
     */
    public final TableField<EventsRecord, String> EVENT_CATALOG = createField(DSL.name("EVENT_CATALOG"), SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>information_schema.EVENTS.EVENT_SCHEMA</code>.
     */
    public final TableField<EventsRecord, String> EVENT_SCHEMA = createField(DSL.name("EVENT_SCHEMA"), SQLDataType.VARCHAR(64), this, "");
     ...
     */
    public final TableField<EventsRecord, EventsIntervalField> INTERVAL_FIELD = createField(DSL.name("INTERVAL_FIELD"), SQLDataType.VARCHAR(18).asEnumDataType(com.baeldung.jooq.introduction.db.information_schema.enums.EventsIntervalField.class), this, "");
     ...
     */
    public final TableField<EventsRecord, EventsStatus> STATUS = createField(DSL.name("STATUS"), SQLDataType.VARCHAR(18).nullable(false).asEnumDataType(com.baeldung.jooq.introduction.db.information_schema.enums.EventsStatus.class), this, "");
