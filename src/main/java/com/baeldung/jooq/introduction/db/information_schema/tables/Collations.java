...
import com.baeldung.jooq.introduction.db.information_schema.enums.CollationsPadAttribute;
...
public class Collations extends TableImpl<CollationsRecord> {
     ...
     */
    public final TableField<CollationsRecord, CollationsPadAttribute> PAD_ATTRIBUTE = createField(DSL.name("PAD_ATTRIBUTE"), SQLDataType.VARCHAR(9).nullable(false).asEnumDataType(com.baeldung.jooq.introduction.db.information_schema.enums.CollationsPadAttribute.class), this, "");
