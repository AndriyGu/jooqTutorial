...
import com.baeldung.jooq.introduction.db.information_schema.enums.ColumnsColumnKey;
...
public class Columns extends TableImpl<ColumnsRecord> {
     ...
     */
    public final TableField<ColumnsRecord, ColumnsColumnKey> COLUMN_KEY = createField(DSL.name("COLUMN_KEY"), SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(com.baeldung.jooq.introduction.db.information_schema.enums.ColumnsColumnKey.class), this, "");
