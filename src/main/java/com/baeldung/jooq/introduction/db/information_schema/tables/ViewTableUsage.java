...
import com.baeldung.jooq.introduction.db.information_schema.tables.records.ViewTableUsageRecord;
...
public class ViewTableUsage extends TableImpl<ViewTableUsageRecord> {
     ...
     */
    public final TableField<ViewTableUsageRecord, String> VIEW_CATALOG = createField(DSL.name("VIEW_CATALOG"), SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>information_schema.VIEW_TABLE_USAGE.VIEW_SCHEMA</code>.
     */
    public final TableField<ViewTableUsageRecord, String> VIEW_SCHEMA = createField(DSL.name("VIEW_SCHEMA"), SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>information_schema.VIEW_TABLE_USAGE.VIEW_NAME</code>.
     */
    public final TableField<ViewTableUsageRecord, String> VIEW_NAME = createField(DSL.name("VIEW_NAME"), SQLDataType.VARCHAR(64), this, "");

    /**
     * The column
     * <code>information_schema.VIEW_TABLE_USAGE.TABLE_CATALOG</code>.
     */
    public final TableField<ViewTableUsageRecord, String> TABLE_CATALOG = createField(DSL.name("TABLE_CATALOG"), SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>information_schema.VIEW_TABLE_USAGE.TABLE_SCHEMA</code>.
     */
    public final TableField<ViewTableUsageRecord, String> TABLE_SCHEMA = createField(DSL.name("TABLE_SCHEMA"), SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>information_schema.VIEW_TABLE_USAGE.TABLE_NAME</code>.
     */
    public final TableField<ViewTableUsageRecord, String> TABLE_NAME = createField(DSL.name("TABLE_NAME"), SQLDataType.VARCHAR(64), this, "");
