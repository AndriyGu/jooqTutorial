...
public class AuthorBook extends TableImpl<AuthorBookRecord> {
    ...
    /**
     * The reference instance of <code>jooqtutorial.author_book</code>
     */
    ...
    /**
     * The column <code>jooqtutorial.author_book.author_id</code>.
     */
    ...
    /**
     * The column <code>jooqtutorial.author_book.book_id</code>.
     */
    ...
    /**
     * Create an aliased <code>jooqtutorial.author_book</code> table reference
     */
    ...
    /**
     * Create a <code>jooqtutorial.author_book</code> table reference
     */
    public AuthorBook() {
    ...
    /**
     * Get the implicit join path to the <code>jooqtutorial.author</code> table.
     */
    ...
    /**
     * Get the implicit join path to the <code>jooqtutorial.book</code> table.
     */
    public Book book() {
        if (_book == null)
