...
public class Tables extends TableImpl<TablesRecord> {
     ...
     */
    public final TableField<TablesRecord, TablesTableType> TABLE_TYPE = createField(DSL.name("TABLE_TYPE"), SQLDataType.VARCHAR(11).nullable(false).asEnumDataType(com.baeldung.jooq.introduction.db.information_schema.enums.TablesTableType.class), this, "");
     ...
     */
    public final TableField<TablesRecord, TablesRowFormat> ROW_FORMAT = createField(DSL.name("ROW_FORMAT"), SQLDataType.VARCHAR(10).asEnumDataType(com.baeldung.jooq.introduction.db.information_schema.enums.TablesRowFormat.class), this, "");
