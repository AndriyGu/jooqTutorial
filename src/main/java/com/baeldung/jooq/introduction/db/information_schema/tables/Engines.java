...
import com.baeldung.jooq.introduction.db.information_schema.tables.records.EnginesRecord;
...
public class Engines extends TableImpl<EnginesRecord> {
     ...
     */
    public final TableField<EnginesRecord, String> ENGINE = createField(DSL.name("ENGINE"), SQLDataType.VARCHAR(21).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.ENGINES.SUPPORT</code>.
     */
    public final TableField<EnginesRecord, String> SUPPORT = createField(DSL.name("SUPPORT"), SQLDataType.VARCHAR(2).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.ENGINES.COMMENT</code>.
     */
    public final TableField<EnginesRecord, String> COMMENT = createField(DSL.name("COMMENT"), SQLDataType.VARCHAR(26).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.ENGINES.TRANSACTIONS</code>.
     */
    public final TableField<EnginesRecord, String> TRANSACTIONS = createField(DSL.name("TRANSACTIONS"), SQLDataType.VARCHAR(1).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.ENGINES.XA</code>.
     */
    public final TableField<EnginesRecord, String> XA = createField(DSL.name("XA"), SQLDataType.VARCHAR(1).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.ENGINES.SAVEPOINTS</code>.
     */
    public final TableField<EnginesRecord, String> SAVEPOINTS = createField(DSL.name("SAVEPOINTS"), SQLDataType.VARCHAR(1).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "");
