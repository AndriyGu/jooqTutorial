...
import com.baeldung.jooq.introduction.db.information_schema.enums.SchemataDefaultEncryption;
...
public class Schemata extends TableImpl<SchemataRecord> {
     ...
     */
    public final TableField<SchemataRecord, String> CATALOG_NAME = createField(DSL.name("CATALOG_NAME"), SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>information_schema.SCHEMATA.SCHEMA_NAME</code>.
     */
    public final TableField<SchemataRecord, String> SCHEMA_NAME = createField(DSL.name("SCHEMA_NAME"), SQLDataType.VARCHAR(64), this, "");
     ...
     */
    public final TableField<SchemataRecord, SchemataDefaultEncryption> DEFAULT_ENCRYPTION = createField(DSL.name("DEFAULT_ENCRYPTION"), SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(com.baeldung.jooq.introduction.db.information_schema.enums.SchemataDefaultEncryption.class), this, "");
