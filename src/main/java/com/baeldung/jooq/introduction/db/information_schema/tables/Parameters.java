...
import com.baeldung.jooq.introduction.db.information_schema.enums.ParametersRoutineType;
import com.baeldung.jooq.introduction.db.information_schema.tables.records.ParametersRecord;
...
public class Parameters extends TableImpl<ParametersRecord> {
     ...
     */
    public final TableField<ParametersRecord, String> SPECIFIC_CATALOG = createField(DSL.name("SPECIFIC_CATALOG"), SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>information_schema.PARAMETERS.SPECIFIC_SCHEMA</code>.
     */
    public final TableField<ParametersRecord, String> SPECIFIC_SCHEMA = createField(DSL.name("SPECIFIC_SCHEMA"), SQLDataType.VARCHAR(64), this, "");
     ...
     */
    public final TableField<ParametersRecord, ParametersRoutineType> ROUTINE_TYPE = createField(DSL.name("ROUTINE_TYPE"), SQLDataType.VARCHAR(9).nullable(false).asEnumDataType(com.baeldung.jooq.introduction.db.information_schema.enums.ParametersRoutineType.class), this, "");
