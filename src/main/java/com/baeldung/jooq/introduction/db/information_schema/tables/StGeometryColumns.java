...
import com.baeldung.jooq.introduction.db.information_schema.tables.records.StGeometryColumnsRecord;
...
public class StGeometryColumns extends TableImpl<StGeometryColumnsRecord> {
     ...
     */
    public final TableField<StGeometryColumnsRecord, String> TABLE_CATALOG = createField(DSL.name("TABLE_CATALOG"), SQLDataType.VARCHAR(64), this, "");

    /**
     * The column
     * <code>information_schema.ST_GEOMETRY_COLUMNS.TABLE_SCHEMA</code>.
     */
    public final TableField<StGeometryColumnsRecord, String> TABLE_SCHEMA = createField(DSL.name("TABLE_SCHEMA"), SQLDataType.VARCHAR(64), this, "");

    /**
     * The column
     * <code>information_schema.ST_GEOMETRY_COLUMNS.TABLE_NAME</code>.
     */
    public final TableField<StGeometryColumnsRecord, String> TABLE_NAME = createField(DSL.name("TABLE_NAME"), SQLDataType.VARCHAR(64), this, "");
