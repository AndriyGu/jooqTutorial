...
public class EventsRecord extends TableRecordImpl<EventsRecord> {
     ...
     */
    public EventsRecord(String eventCatalog, String eventSchema, String eventName, String definer, String timeZone, String eventBody, String eventDefinition, String eventType, LocalDateTime executeAt, String intervalValue, EventsIntervalField intervalField, String sqlMode, LocalDateTime starts, LocalDateTime ends, EventsStatus status, String onCompletion, LocalDateTime created, LocalDateTime lastAltered, LocalDateTime lastExecuted, String eventComment, UInteger originator, String characterSetClient, String collationConnection, String databaseCollation) {
        super(Events.EVENTS);
